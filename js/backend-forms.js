...
if (serviceForm) {
    serviceForm.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            const response = await fetch('backend/process-service-request.php', {
                method: 'POST',
                body: formData
            });
...
if (registerForm) {
    registerForm.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            const response = await fetch('backend/process-registration.php', {
                method: 'POST',
                body: formData
            });
...
if (loginForm) {
    loginForm.addEventListener('submit', async function (e) {
        ...
        try {
            const formData = new FormData(this);
            const response = await fetch('backend/process-login.php', {
                method: 'POST',
                body: formData
            });
            const result = await response.json();
...
async function loadRealStats() {
    ...
    try {
        const res = await fetch('backend/get-statistics.php');
